...
# for i in 1:1
    ...
    global plo = plot(time_series, r, legend=:bottomright)
    # a = maximum(r)/2
    peaks = maxima(r)
    mins = minima(r)
    ...
    pi² = GRAVITATIONAL_CONSTANT*M_TOT*T^2/a/(a+SOFT_PARAM)^2/4/pi^2
